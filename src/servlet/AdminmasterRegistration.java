...
/**
 * Servlet implementation class AdminmasterRegistration
 */
@WebServlet("/AdminmasterRegistration")
public class AdminmasterRegistration extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminmasterRegistration() {
        super();
...
String path = "";
		...
		if (session == null) {
			...
			path = "WEB-INF/Adminmaster_Registration.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(useridflg == false){
			...
			path = "WEB-INF/Adminmaster_Registration_Confirmation.jsp";
		}
